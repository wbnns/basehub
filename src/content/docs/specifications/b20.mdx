...
<Aside type="caution">
B20's mainnet activation has been postponed in the wake of an unrelated stability incident; the team is holding back the Activation Registry rollout to keep the launch smooth, and a revised date will follow. Base Sepolia and Vibenet are unaffected and remain on schedule. Confirm the Activation Registry is enabled before attempting a deployment.
</Aside>
