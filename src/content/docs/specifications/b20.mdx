...
<Aside type="caution">
Mainnet activation for B20 is expected on **June 26, 2026 at 6pm UTC**. Allow up to roughly an hour after that for the Activation Registry to finish coming online, and confirm it is enabled before attempting a deployment.
</Aside>
