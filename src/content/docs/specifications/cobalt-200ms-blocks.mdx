...
This work carried the name **Denim** until early September 2026, when upstream reassigned it to Cobalt and handed the Denim slot to account abstraction instead. Nothing technical moved with the rename — only the fork it ships in, and the target month.
</Aside>
