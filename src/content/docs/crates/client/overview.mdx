...
The `client` crate group assembles the full Base Reth Node. It provides the CLI, engine API integration, flashblocks support, metering RPC, proof extensions, and transaction pool tracing.
