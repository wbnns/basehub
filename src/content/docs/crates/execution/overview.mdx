---
title: execution
description: Execution layer — EVM, chain specification, payload building, storage, transaction pool, and state management.
---

The `execution` crate group implements the core execution layer of the Base Reth Node. It handles everything from EVM execution to state storage, transaction pool management, and payload building.
