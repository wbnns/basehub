...
| [ingress-rpc](/crates/infra/ingress-rpc/) | `ingress-rpc-lib` | RPC ingress proxy (Kafka-based) — **retired 2026-09-21** |
...
- **ingress-rpc** — An RPC proxy that routed incoming JSON-RPC requests, using Kafka for message queuing. Removed from the workspace on 2026-09-21; the proxy layer is the entry point now, and no crate took the forwarding hop over.
