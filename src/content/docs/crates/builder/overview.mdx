...
The `builder` crate group handles block building and flashblock production. The builder produces flashblocks at 200ms intervals and publishes them for streaming to clients.
