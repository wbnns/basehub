...
The `consensus` crate group implements the OP Stack consensus protocol for Base. These crates are derived from the [Kona](https://github.com/op-rs/kona) project and handle L1 derivation, P2P networking, gossip, and block sequencing.
