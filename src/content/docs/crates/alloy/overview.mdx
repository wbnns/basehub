...
The `alloy` crate group provides Base-specific extensions to the [Alloy](https://github.com/alloy-rs/alloy) library, which is the standard Rust toolkit for Ethereum types and RPC.
