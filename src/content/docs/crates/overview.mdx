...
description: Overview of the 8 top-level crate groups in the base/base workspace.
---

The `base/base` repository is organized as a Cargo workspace with 8 top-level crate groups. Each group contains multiple sub-crates that handle a specific domain of the Base Reth Node.
