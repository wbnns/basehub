...
<Aside type="caution" title="A draft proposal would retire Flashblocks">
Upstream has published a draft spec for [Denim](/specifications/denim-200ms-blocks/), which would make each 200ms interval a canonical block and stop Flashblocks production altogether. It is a request for feedback, not a commitment — nothing is scheduled on Sepolia or Mainnet. Everything on this page describes how Base works today.
</Aside>
