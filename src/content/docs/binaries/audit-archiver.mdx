...
`audit-archiver` consumes audit log messages from Kafka (produced by `ingress-rpc`) and archives them to S3-compatible storage for long-term retention, debugging, and compliance.
