...
`base-reth-node` is the primary binary for running a Base Reth Node. It extends the standard Reth OP node with five custom extensions that add Flashblocks support, transaction pool RPC, resource metering, and proofs history.
