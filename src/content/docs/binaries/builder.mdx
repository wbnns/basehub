...
`base-builder` is the block builder service responsible for producing flashblocks at 200ms intervals and assembling canonical blocks. It uses `FlashblocksServiceBuilder` to orchestrate the block building pipeline.
