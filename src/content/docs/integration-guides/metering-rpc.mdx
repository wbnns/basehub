---
title: Metering RPC
description: Guide to the Metering API for gas estimation and resource tracking.
---

The Metering API provides resource metering based on transaction simulations. It gives builders and applications accurate gas estimates, resource consumption breakdowns, and metering data for transactions before they are included in a block.
