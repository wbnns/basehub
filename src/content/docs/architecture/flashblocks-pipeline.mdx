...
Flashblocks are partial block updates produced every 200 milliseconds during a 2-second L2 block interval. They give users and applications sub-second confirmation of transaction inclusion without changing the final block structure or the consensus protocol.

This page describes the internal pipeline: how the builder produces flashblocks, how they are streamed to consumers, and how state is reconciled when the full block is sealed.
