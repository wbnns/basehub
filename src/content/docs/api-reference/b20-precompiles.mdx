...
One behavioural change is already in the node source, gated behind [Denim](/specifications/denim-overview/) rather than Cobalt. It adds no selector and removes none.
