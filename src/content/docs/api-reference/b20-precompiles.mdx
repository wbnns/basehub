...
Two changes are already in the node source, gated behind [Denim](/specifications/denim-overview/) rather than Cobalt. Denim has a target month but no activation timestamp yet.
