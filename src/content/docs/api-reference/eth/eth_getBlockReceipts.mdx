...
sources:
- base/docs:docs/base-chain/api-reference/ethereum-json-rpc-api/eth_getBlockReceipts.mdx
---
...
<Aside type="caution">
The public Base RPC endpoints (`mainnet.base.org`, `sepolia.base.org`) reject this method with HTTP 403. It requires a dedicated or third-party RPC provider — see the [node providers](/node-operations/node-providers/) page.
</Aside>

<Aside type="tip">
**Flashblocks:** call `https://mainnet.base.org` with `"pending"` to fetch receipts for all pre-confirmed transactions in the current Flashblock.
</Aside>
