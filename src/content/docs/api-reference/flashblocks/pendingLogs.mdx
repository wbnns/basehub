---
title: pendingLogs
description: Subscribe to logs from pre-confirmed transactions matching an optional address and topics filter, with sub-block latency over a WebSocket connection.
sources:
- base/docs:docs/base-chain/api-reference/flashblocks-api/pendingLogs.mdx
---
