...
<Aside type="caution">
Upstream plans to deprecate Flashblocks in the [Cobalt](/specifications/cobalt-200ms-blocks/) hardfork. That upgrade is not finalised. Canonical 200ms block behaviour is available for early testing on Vibenet, and [Migrate to 200ms Blocks](/flashblocks/migrate-to-200ms-blocks/) maps every method on this page to its eventual replacement.
</Aside>
