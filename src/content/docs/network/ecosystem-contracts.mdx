...
sources:
- base/docs:docs/base-chain/network-information/ecosystem-contracts.mdx
---

import { Aside } from '@astrojs/starlight/components';

The tables below list deployment addresses for widely used onchain apps on Base.
...
<Aside type="note">
Two community-built UIs let you drive the Uniswap contracts from the browser instead of calling them directly: [BaseX](https://basex-test.vercel.app/swap?currencyA=ETH&currencyB=0x036CbD53842c5426634e7929541eC2318f3dCF7e&focus=source) and [DapDap](https://testnet.base.dapdap.net/uniswap/swap).
</Aside>
