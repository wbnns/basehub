---
title: Local Devnet
description: Running a local development network.
---

The `base/base` repository includes a Docker Compose-based devnet that spins up a complete local network. This is useful for integration testing, debugging, and experimenting with features like flashblocks without connecting to a public testnet.

The devnet configuration lives in `etc/docker/docker-compose.yml`.
