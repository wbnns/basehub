...
description: How to run the Base Reth Node.
---

After [building from source](/getting-started/building/) or [building a Docker image](/getting-started/docker/), you can start the `base-reth-node` binary. This page covers basic usage. For production deployment guidance, see [Node Operations](/node-operations/deployment/).
