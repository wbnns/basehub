...
Use `just pr` while iterating and `just ci` before requesting review. See [Testing](/getting-started/testing/) for the tiers those tests are drawn from and how each CI stage differs.
...
- [Testing](/getting-started/testing/) -- the four testing tiers and what each CI stage runs.
