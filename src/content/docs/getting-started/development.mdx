...
description: Day-to-day development — check, test, fix.
---

The `base/base` repository uses [Just](https://github.com/casey/just) recipes to orchestrate common development tasks. This page walks through the commands you will use daily when working on the codebase.
