---
title: Docker Builds
description: Building and running base/base with Docker.
---

Docker provides a reproducible way to build and run the node without installing the full Rust toolchain on the host. The repository ships several Dockerfiles under `etc/docker/`.
