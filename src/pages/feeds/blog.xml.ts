...
const UPSTREAM = 'https://api.paragraph.com/blogs/rss/@blog.base.dev';
...
export const GET: APIRoute = async () => {
  try {
    ...
    console.warn(`[feeds/blog] upstream fetch failed: ${message}`);
    return new Response(
      `<?xml version="1.0" encoding="UTF-8"?>
<rss version="2.0">
  <channel>
    <title>Base Engineering Blog (upstream unavailable)</title>
